...
set_property IOSTANDARD LVCMOS18 [get_ports e_mdc_2]
set_property IOSTANDARD LVCMOS18 [get_ports e_mdio_2]
set_property IOSTANDARD LVCMOS18 [get_ports e_reset_2]
set_property IOSTANDARD LVCMOS18 [get_ports rgmii_rxc_2]
set_property IOSTANDARD LVCMOS18 [get_ports rgmii_rxctl_2]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_rxd_2[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_rxd_2[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_rxd_2[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_rxd_2[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports rgmii_txc_2]
set_property IOSTANDARD LVCMOS18 [get_ports rgmii_txctl_2]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_txd_2[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_txd_2[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_txd_2[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {rgmii_txd_2[3]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports SFP1_LOSS]

set_property PACKAGE_PIN AF6 [get_ports SFP_CLK0_P]
set_property PACKAGE_PIN AF5 [get_ports SFP_CLK0_N]

set_property IOSTANDARD LVCMOS33 [get_ports SFP_CLK0_P]
set_property IOSTANDARD LVCMOS33 [get_ports SFP_CLK0_N]
...
###############i doubt that these set false path would lead to error##############
