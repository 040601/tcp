...
ila_4 sd(
   ...
   .probe2( block_write_data_rd),
    ...
    .probe3(sd_sec_write),//sd 卡扇区写请求
    .probe4(sd_sec_write_addr),//sd 卡扇区写地址
    .probe5(sd_sec_write_data),//sd 卡扇区写请求数据
    .probe6(sd_sec_write_end),
    .probe7(block_write_req_ack),
    .probe8(block_write_req),
    .probe9(cmd_req_ack),
    .probe10(cmd_req)
