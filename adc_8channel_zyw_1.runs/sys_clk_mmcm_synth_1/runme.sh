...
HD_PWD='E:/vivadoprojects/adcether/adc_8channel_zyw_3/adc_8channel_zyw_1.runs/sys_clk_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_clk_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_clk_mmcm.tcl
