...
HD_PWD='E:/vivadoprojects/adcether/adc_8channel_zyw_3/adc_8channel_zyw_1.runs/fifo_tcp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_tcp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_tcp.tcl
